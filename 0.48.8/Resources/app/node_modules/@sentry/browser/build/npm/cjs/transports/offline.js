...
function createIndexedDbStore(options) {
  ...
  return {
    push: async (env) => {
      try {
        const serialized = await utils.serializeEnvelope(env);
    ...
    shift: async () => {
      try {
        ...
        if (deserialized) {
          return utils.parseEnvelope(deserialized);
        }
      } catch (_) {
        //
      }
...
exports.push = push;
exports.shift = shift;
exports.unshift = unshift;//# sourceMappingURL=https://cursor-sourcemaps.s3.amazonaws.com/sourcemaps/7801a556824585b7f2721900066bc87c4a09b740/node_modules/@sentry/browser/build/npm/cjs/transports/offline.js.map
