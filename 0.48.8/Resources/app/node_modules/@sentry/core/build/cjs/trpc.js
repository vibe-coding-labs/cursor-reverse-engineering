    ...
    if (options.attachRpcInput !== undefined ? options.attachRpcInput : clientOptions && clientOptions.sendDefaultPii) {
      ...
      if (getRawInput !== undefined && typeof getRawInput === 'function') {
        try {
          ...
          trpcContext.input = utils.normalize(rawRes);
        } catch (err) {
          // noop
        }
      }
...
exports.trpcMiddleware = trpcMiddleware;//# sourceMappingURL=https://cursor-sourcemaps.s3.amazonaws.com/sourcemaps/7801a556824585b7f2721900066bc87c4a09b740/node_modules/@sentry/core/build/cjs/trpc.js.map
