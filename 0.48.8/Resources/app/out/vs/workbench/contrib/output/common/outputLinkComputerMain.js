...
function _interopRequireWildcard(e, t) {
  ...
  return (_interopRequireWildcard = function _interopRequireWildcard(e, t) {
    ...
    for (var _t16 in e)
      'default' !== _t16 &&
        {}.hasOwnProperty.call(e, _t16) &&
        ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, _t16)) &&
        (i.get || i.set)
          ? o(f, _t16, i)
          : (f[_t16] = e[_t16]));
    return f;
...
!(function () {
  try {
    ...
    n &&
      ...
      (e._sentryDebugIds[n] = 'deecdd7a-55c6-509b-a1b5-dfe25a01c4e0'));
  } catch (e) {}
})();
var _V = function V1(e, t) {
  return (
    (_V =
      Object.setPrototypeOf ||
      ({
...
function __esDecorate(e, t, r, n, i, s) {
  ...
  for (
    ...
    var L = {};
    for (var R in n) L[R] = R === 'access' ? {} : n[R];
    for (var R in n.access) L.access[R] = n.access[R];
    L.addInitializer = function (F) {
    ...
    if (l === 'accessor') {
      ...
      (c = o(M.get)) && (f.get = c), (c = o(M.set)) && (f.set = c), (c = o(M.init)) && i.unshift(c);
    } else (c = o(M)) && (l === 'field' ? i.unshift(c) : (f[u] = c));
  }
  a && Object.defineProperty(a, n.name, f), (m = !0);
}
...
function __asyncGenerator(e, t, r) {
  ...
  function o(p) {
    return function (L) {
      return Promise.resolve(L).then(p, c);
    };
  }
  function l(p, L) {
    n[p] &&
  ...
  function a(p) {
    p.value instanceof __await ? Promise.resolve(p.value.v).then(f, c) : m(s[0][2], p);
  }
  function f(p) {
    u('next', p);
  }
  ...
  function m(p, L) {
    p(L), s.shift(), s.length && u(s[0][0], s[0][1]);
  }
}
...
function __disposeResources(e) {
  function t(n) {
    (e.error = e.hasError ? new Et(n, e.error, 'An error was suppressed during disposal.') : n),
      (e.hasError = !0);
  }
  function r() {
    for (; e.stack.length; ) {
...
var S2 =
  ...
  X = globalThis,
  V = void 0;
_typeof(X.vscode) < 'u' && _typeof(X.vscode.process) < 'u'
  ? (V = X.vscode.process)
  : (typeof process === 'undefined' ? 'undefined' : _typeof(process)) < 'u' &&
    ...
    (V = process);
var be =
    typeof ((_V2 = V) === null || _V2 === void 0 || (_V2 = _V2.versions) === null || _V2 === void 0
      ? void 0
      : _V2.electron) == 'string',
  Rt = be && ((_V3 = V) === null || _V3 === void 0 ? void 0 : _V3.type) === 'renderer';
if (_typeof(V) == 'object') {
  (A1 = V.platform === 'win32'),
    ($1 = V.platform === 'darwin'),
    (m1 = V.platform === 'linux'),
    (_t = m1 && !!V.env.SNAP && !!V.env.SNAP_REVISION),
    (xt = be),
    (St = !!V.env.CI || !!V.env.BUILD_ARTIFACTSTAGINGDIRECTORY),
    (E1 = u1),
    (_1 = u1);
  ...
  (typeof navigator === 'undefined' ? 'undefined' : _typeof(navigator)) == 'object' && !Rt
    ? ((J = navigator.userAgent),
      (A1 = J.indexOf('Windows') >= 0),
      ($1 = J.indexOf('Macintosh') >= 0),
      (Pt =
        (J.indexOf('Macintosh') >= 0 || J.indexOf('iPad') >= 0 || J.indexOf('iPhone') >= 0) &&
        !!navigator.maxTouchPoints &&
        navigator.maxTouchPoints > 0),
      (m1 = J.indexOf('Linux') >= 0),
      (kt = ((_J = J) === null || _J === void 0 ? void 0 : _J.indexOf('Mobi')) >= 0),
      (H1 = !0),
      (_1 = de() || u1),
      (E1 = navigator.language.toLowerCase()),
      (ve = E1))
...
var B1 = 0;
$1 ? (B1 = 1) : A1 ? (B1 = 3) : m1 && (B1 = 2);
var n1 = A1,
  Tt = $1,
  Mt = m1,
  jt = me,
  It = H1,
  Ut = H1 && typeof X.importScripts == 'function',
  Dt = Ut ? X.origin : void 0,
  Z = J,
  G = _1,
  pe;
(function (e) {
...
var qt = typeof X.postMessage == 'function' && !X.importScripts,
  Wt = (function () {
    if (qt) {
      var _e2 = [];
...
var zt = !!(Z && Z.indexOf('Chrome') >= 0),
  k2 = !!(Z && Z.indexOf('Firefox') >= 0),
  O2 = !!(!zt && Z && Z.indexOf('Safari') >= 0),
  R2 = !!(Z && Z.indexOf('Edg/') >= 0),
  T2 = !!(Z && Z.indexOf('Android') >= 0),
  i1,
  Z1 = globalThis.vscode;
if (_typeof(Z1) < 'u' && _typeof(Z1.process) < 'u') {
  var _e3 = Z1.process;
  i1 = {
    get platform() {
      return _e3.platform;
  ...
  _process2 === void 0
    ...
    : (i1 = {
        get platform() {
          return n1 ? 'win32' : Tt ? 'darwin' : 'linux';
        },
        get arch() {},
        get env() {
          return {};
...
function Xt(e, t) {
  if (e === null || _typeof(e) != 'object') throw new ye(t, 'Object', e);
}
function k(e, t) {
      ...
      if (!(o === a - 1 || l === 1))
        if (l === 2) {
          if (
            i.length < 2 ||
            s !== 2 ||
            i.charCodeAt(i.length - 1) !== Q ||
            i.charCodeAt(i.length - 2) !== Q
          ) {
            if (i.length > 2) {
...
function Ce(e, t) {
  Xt(t, 'pathObject');
  var r = t.dir || t.root,
    n = t.base || ''.concat(t.name || '').concat(Yt(t.ext));
...
var O = {
    resolve: function resolve() {
      ...
      for (var i = e.length - 1; i >= -1; i--) {
        ...
        if (o === 1) y(f) && ((l = 1), (a = !0));
          ...
          if (((a = !0), y(s.charCodeAt(1)))) {
            ...
            if (c < o && c !== m) {
              var p = s.slice(m, c);
              for (m = c; c < o && y(s.charCodeAt(c)); ) c++;
              if (c < o && c !== m) {
                for (m = c; c < o && !y(s.charCodeAt(c)); ) c++;
                (c === o || c !== m) &&
                  ((u = '\\\\'.concat(p, '\\').concat(s.slice(m, c))), (l = c));
              }
            }
          } else l = 1;
        } else
      ...
      return (
        (r = P1(r, !n, '\\', y)), n ? ''.concat(t, '\\').concat(r) : ''.concat(t).concat(r) || '.'
      );
    },
    ...
    isAbsolute: function isAbsolute(e) {
      ...
      return y(r) || (t > 2 && t1(r) && e.charCodeAt(1) === e1 && y(e.charCodeAt(2)));
    },
    join: function join() {
    ...
    relative: function relative(e, t) {
      ...
      var c = -1,
        m = 0;
      for (; m < f; m++) {
        var L = e.charCodeAt(i + m);
        if (L !== t.charCodeAt(l + m)) break;
        L === q && (c = m);
      }
      if (m !== f) {
        if (c === -1) return n;
        ...
        if (a > f) {
          if (t.charCodeAt(l + m) === q) return n.slice(l + m + 1);
          if (m === 2) return n.slice(l + m);
        }
        o > f && (e.charCodeAt(i + m) === q ? (c = m) : m === 2 && (c = 3)), c === -1 && (c = 0);
      }
      var p = '';
      for (m = i + c + 1; m <= s; ++m)
        (m === s || e.charCodeAt(m) === q) && (p += p.length === 0 ? '..' : '\\..');
      return (
        (l += c),
        p.length > 0
          ? ''.concat(p).concat(n.slice(l, u))
    ...
    toNamespacedPath: function toNamespacedPath(e) {
      ...
      if (t.charCodeAt(0) === q) {
        if (t.charCodeAt(1) === q) {
          ...
          if (r !== Jt && r !== Q) return '\\\\?\\UNC\\'.concat(t.slice(2));
        }
      } else if (t1(t.charCodeAt(0)) && t.charCodeAt(1) === e1 && t.charCodeAt(2) === q)
        return '\\\\?\\'.concat(t);
      return e;
    },
    dirname: function dirname(e) {
      ...
      if (y(i)) {
        ...
        t1(i) && e.charCodeAt(1) === e1 && ((r = t > 2 && y(e.charCodeAt(2)) ? 3 : 2), (n = r));
      var s = -1,
        o = !0;
      for (var _l = t - 1; _l >= n; --_l)
        if (y(e.charCodeAt(_l))) {
          if (!o) {
            s = _l;
            break;
          }
    ...
    basename: function basename(e, t) {
      ...
      var r = 0,
        ...
        s;
      if (
        (e.length >= 2 && t1(e.charCodeAt(0)) && e.charCodeAt(1) === e1 && (r = 2),
    ...
    extname: function extname(e) {
      ...
      var t = 0,
        ...
        s = !0,
        o = 0;
      e.length >= 2 && e.charCodeAt(1) === e1 && t1(e.charCodeAt(0)) && (t = n = 2);
    ...
    parse: function parse(e) {
      ...
      if (y(i)) {
        if (((n = 1), y(e.charCodeAt(1)))) {
          ...
          if (c < r && c !== m) {
            for (m = c; c < r && y(e.charCodeAt(c)); ) c++;
            if (c < r && c !== m) {
              for (m = c; c < r && !y(e.charCodeAt(c)); ) c++;
              c === r ? (n = c) : c !== m && (n = c + 1);
            }
      ...
      } else if (t1(i) && e.charCodeAt(1) === e1) {
  ...
  E = {
    resolve: function resolve() {
      ...
      for (var n = arguments.length - 1; n >= -1 && !r; n--) {
        var i = n >= 0 ? (n < 0 || arguments.length <= n ? undefined : arguments[n]) : Gt();
        k(i, 'paths['.concat(n, ']')),
          i.length !== 0 && ((t = ''.concat(i, '/').concat(t)), (r = i.charCodeAt(0) === I));
      }
      return (t = P1(t, !r, '/', K1)), r ? '/'.concat(t) : t.length > 0 ? t : '.';
    },
    normalize: function normalize(e) {
    ...
    isAbsolute: function isAbsolute(e) {
      return k(e, 'path'), e.length > 0 && e.charCodeAt(0) === I;
    },
    join: function join() {
      if (arguments.length === 0) return '.';
      var t;
    ...
    relative: function relative(e, t) {
      ...
      if (a === l)
        if (o > l) {
          if (t.charCodeAt(s + a) === I) return t.slice(s + a + 1);
          if (a === 0) return t.slice(s + a);
        } else i > l && (e.charCodeAt(r + a) === I ? (u = a) : a === 0 && (u = 0));
      var f = '';
      for (a = r + u + 1; a <= n; ++a)
        (a === n || e.charCodeAt(a) === I) && (f += f.length === 0 ? '..' : '/..');
    ...
    parse: function parse(e) {
      ...
      for (; u >= n; --u) {
        ...
        o === -1 && ((l = !1), (o = u + 1)),
          f === Q ? (i === -1 ? (i = u) : a !== 1 && (a = 1)) : i !== -1 && (a = -1);
      }
      if (o !== -1) {
        var _f = s === 0 && r ? 1 : s;
        i === -1 || a === 0 || (a === 1 && i === o - 1 && i === s + 1)
          ? (t.base = t.name = e.slice(_f, o))
          : ((t.name = e.slice(_f, i)), (t.base = e.slice(_f, o)), (t.ext = e.slice(i, o)));
      }
...
var Qt = W ? O.normalize : E.normalize,
  j2 = W ? O.isAbsolute : E.isAbsolute,
  er = W ? O.join : E.join,
  tr = W ? O.resolve : E.resolve,
  rr = W ? O.relative : E.relative,
  nr = W ? O.dirname : E.dirname,
  I2 = W ? O.basename : E.basename,
  U2 = W ? O.extname : E.extname,
  D2 = W ? O.format : E.format,
  q2 = W ? O.parse : E.parse,
  W2 = W ? O.toNamespacedPath : E.toNamespacedPath,
  S1 = W ? O.sep : E.sep,
  z2 = W ? O.delimiter : E.delimiter,
  ir = /^\w[\w\d+.-]*$/,
  sr = /^\//,
  or = /^\/\//;
function lr(e, t) {
...
var x = '',
        ...
        },
        {
          ...
          value: function _with(t) {
            ...
            var r = t.scheme,
              ...
              o = t.fragment;
            return (
              r === void 0 ? (r = this.scheme) : r === null && (r = x),
              n === void 0 ? (n = this.authority) : n === null && (n = x),
              i === void 0 ? (i = this.path) : i === null && (i = x),
      ...
      [
        ...
        },
        {
          ...
          value: function parse(t) {
            ...
            var n = cr.exec(t);
            return n
              ? new c1(n[2] || x, O1(n[4] || x), O1(n[5] || x), O1(n[7] || x), O1(n[9] || x), r)
              : new c1(x, x, x, x, x);
          },
        },
        {
          ...
          value: function file(t) {
            var r = x;
            if ((n1 && (t = t.replace(/\\/g, B)), t[0] === B && t[1] === B)) {
              var n = t.indexOf(B, 2);
              n === -1
                ? ((r = t.substring(2)), (t = B))
                : ((r = t.substring(2, n)), (t = t.substring(n) || B));
            }
            return new c1('file', r, t, x, x);
          },
        },
        {
          key: 'from',
          value: function from(t, r) {
            return new c1(t.scheme, t.authority, t.path, t.query, t.fragment, r);
          },
        },
        {
          key: 'joinPath',
          value: function joinPath(t) {
            ...
            var n;
            for (
              var _len2 = arguments.length, r = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1;
              _key2 < _len2;
              _key2++
            ) {
            ...
            return (
              n1 && t.scheme === 'file'
                ? (n = D1.file(O.join.apply(O, [k1(t, !0)].concat(r))).path)
  ...
  Le = n1 ? 1 : void 0,
  c1 = /*#__PURE__*/ (function (_z) {
    function c1() {
      var _this2;
      _classCallCheck(this, c1);
      (_this2 = _callSuper(this, c1, arguments)),
    ...
    return _createClass(c1, [
      ...
      },
      {
        ...
        value: function toString() {
          ...
          return e
            ? J1(this, !0)
            : (this._formatted || (this._formatted = J1(this, !1)), this._formatted);
        },
      },
      {
        key: 'toJSON',
        value: function toJSON() {
          ...
          return (
            this._fsPath && ((e.fsPath = this._fsPath), (e._sep = Le)),
...
function fr(e) {
  ...
  for (var r = 0; r < e.length; r++) {
    ...
    n === 35 || n === 63
      ? (t === void 0 && (t = e.substr(0, r)), (t += Ne[n]))
      : t !== void 0 && (t += e[r]);
  }
  return t !== void 0 ? t : e;
}
...
function J1(e, t) {
  ...
  if (o) {
    if (o.length >= 3 && o.charCodeAt(0) === 47 && o.charCodeAt(2) === 58) {
      var _a = o.charCodeAt(1);
      _a >= 65 &&
        _a <= 90 &&
        (o = '/'.concat(String.fromCharCode(_a + 32), ':').concat(o.substr(3)));
    } else if (o.length >= 2 && o.charCodeAt(1) === 58) {
      var _a2 = o.charCodeAt(0);
      _a2 >= 65 &&
        _a2 <= 90 &&
        (o = ''.concat(String.fromCharCode(_a2 + 32), ':').concat(o.substr(2)));
    }
    n += r(o, !0, !1);
  }
  return l && ((n += '?'), (n += r(l, !1, !1))), u && ((n += '#'), (n += t ? u : Ae(u, !1, !1))), n;
}
function $e(e) {
  try {
...
var Ee = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function O1(e) {
  return e.match(Ee)
    ? e.replace(Ee, function (t) {
        return $e(t);
      })
    : e;
}
...
var F2 =
    ...
    /*#__PURE__*/ (function () {
      function F2(e, t) {
        ...
        (this.b = t), (this.a = new Map()), (this[_e] = 'SetWithKey');
...
function xe(e) {
  if (e instanceof Error) {
    ...
    return {
      ...
      message: r,
      stack: n,
      noTelemetry: Y1.isErrorNoTelemetry(e),
    };
  }
  return e;
}
var X1 = 'Canceled';
function vr(e) {
  return e instanceof br ? !0 : e instanceof Error && e.name === X1 && e.message === X1;
}
var br = /*#__PURE__*/ (function (_Error2) {
    function br() {
      var _this5;
      _classCallCheck(this, br);
      (_this5 = _callSuper(this, br, [X1])), (_this5.name = _this5.message);
      return _this5;
    }
    _inherits(br, _Error2);
    return _createClass(br);
  })(/*#__PURE__*/ _wrapNativeSuper(Error)),
  Y1 = /*#__PURE__*/ (function (_Error3) {
    function ue(t) {
      var _this6;
      _classCallCheck(this, ue);
      (_this6 = _callSuper(this, ue, [t])), (_this6.name = 'CodeExpectedError');
      return _this6;
    }
    _inherits(ue, _Error3);
      ...
      return _createClass(dt, [
        {
          ...
          value: function findLastMonotonous(t) {
            ...
            var r = pr(this.e, t, this.c);
            return (this.c = r + 1), r === -1 ? void 0 : this.e[r];
          },
        },
      ]);
    })()),
    (_dt.assertInvariants = !1),
    _dt),
  G1;
(function (e) {
  function t(s) {
...
var yr = function yr(e, t) {
  ...
  Se,
  ke,
  Cr = /*#__PURE__*/ _createClass(function Cr(e, t) {
...
var Oe =
    ((_ref = ((Pe = Symbol.toStringTag), Symbol.iterator)),
    (_g = /*#__PURE__*/ (function () {
      function g1(t, r) {
        _classCallCheck(this, g1);
        if (((this[Pe] = 'ResourceMap'), t instanceof g1))
          (this.d = new Map(t.d)), (this.e = r !== null && r !== void 0 ? r : g1.c);
        else if (Lr(t)) {
          (this.d = new Map()), (this.e = r !== null && r !== void 0 ? r : g1.c);
        ...
        } else (this.d = new Map()), (this.e = t !== null && t !== void 0 ? t : g1.c);
      }
      return _createClass(g1, [
        {
          key: 'set',
          value: function set(t, r) {
            return this.d.set(this.e(t), new Cr(t, r)), this;
          },
        },
        {
          key: 'get',
    ...
    _g),
  B2 = /*#__PURE__*/ (function (_ref2) {
    function B2(e, t) {
      _classCallCheck(this, B2);
      (this[Se] = 'ResourceSet'),
        !e || typeof e == 'function'
          ? (this.c = new Oe(e))
          : ((this.c = new Oe(t)), e.forEach(this.add, this));
    }
  ...
  })(((Se = Symbol.toStringTag), Symbol.iterator)),
  Re;
(function (e) {
  (e[(e.None = 0)] = 'None'), (e[(e.AsOld = 1)] = 'AsOld'), (e[(e.AsNew = 2)] = 'AsNew');
})(Re || (Re = {}));
var Z2 = /*#__PURE__*/ (function (_ref3) {
    function Z2() {
  ...
  })(((ke = Symbol.toStringTag), Symbol.iterator)),
...
(function (e) {
  var _marked = /*#__PURE__*/ _regeneratorRuntime().mark(i),
    ...
    _marked3 = /*#__PURE__*/ _regeneratorRuntime().mark(m),
    _marked4 = /*#__PURE__*/ _regeneratorRuntime().mark(p),
    _marked5 = /*#__PURE__*/ _regeneratorRuntime().mark(L),
    _marked6 = /*#__PURE__*/ _regeneratorRuntime().mark(R);
  function t(w) {
    return w && _typeof(w) == 'object' && typeof w[Symbol.iterator] == 'function';
  }
  e.is = t;
  var r = Object.freeze([]);
  function n() {
  ...
  function f(w, N) {
    var _ = 0;
    var _iterator16 = _createForOfIteratorHelper(w),
      _step16;
    try {
  ...
  e.some = f;
  function c(w, N) {
    var _iterator17 = _createForOfIteratorHelper(w),
      _step17;
    try {
  ...
  e.find = c;
  function m(w, N) {
    var _iterator18, _step18, _;
    return _regeneratorRuntime().wrap(
      function m$(_context9) {
        while (1)
          switch ((_context9.prev = _context9.next)) {
            case 0:
              _iterator18 = _createForOfIteratorHelper(w);
              _context9.prev = 1;
              _iterator18.s();
            case 3:
  ...
  e.filter = m;
  function p(w, N) {
    var _, _iterator19, _step19, D;
    return _regeneratorRuntime().wrap(
      function p$(_context0) {
        while (1)
          switch ((_context0.prev = _context0.next)) {
            case 0:
              _ = 0;
              _iterator19 = _createForOfIteratorHelper(w);
              _context0.prev = 2;
              _iterator19.s();
            case 4:
  ...
  e.map = p;
  function L(w, N) {
    var _, _iterator20, _step20, D;
    return _regeneratorRuntime().wrap(
      function L$(_context1) {
        while (1)
          switch ((_context1.prev = _context1.next)) {
            case 0:
              _ = 0;
              _iterator20 = _createForOfIteratorHelper(w);
              _context1.prev = 2;
              _iterator20.s();
            case 4:
              ...
              D = _step20.value;
              return _context1.delegateYield(N(D, _++), 't0', 7);
            case 7:
              _context1.next = 4;
              break;
            case 9:
  ...
  function R() {
    var _len3,
      ...
      N,
      _args10 = arguments;
    return _regeneratorRuntime().wrap(function R$(_context10) {
      while (1)
        switch ((_context10.prev = _context10.next)) {
          case 0:
            for (_len3 = _args10.length, w = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
              w[_key3] = _args10[_key3];
            }
            (_i = 0), (_w = w);
          case 2:
            if (!(_i < _w.length)) {
            ...
            N = _w[_i];
            return _context10.delegateYield(N, 't0', 5);
          case 5:
            _i++;
            _context10.next = 2;
            break;
  ...
  e.reduce = M;
  function F(w, N) {
    var _ = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : w.length;
        ...
        while (1)
          switch ((_context11.prev = _context11.next)) {
            case 0:
              N < -w.length && (N = 0),
                N < 0 && (N += w.length),
                _ < 0 ? (_ += w.length) : _ > w.length && (_ = w.length);
            case 1:
              if (!(N < _)) {
                _context11.next = 7;
                break;
  ...
  function F1(w) {
    ...
    var _ = [];
    if (N === 0) return [_, w];
    var D = w[Symbol.iterator]();
    for (var l1 = 0; l1 < N; l1++) {
      var C1 = D.next();
      if (C1.done) return [_, e.empty()];
      _.push(C1.value);
    }
    return [
      _,
  ...
  function _o() {
    _o = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(w) {
        var N, _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _;
        return _regeneratorRuntime().wrap(
          function _callee2$(_context12) {
            while (1)
              switch ((_context12.prev = _context12.next)) {
                ...
                case 29:
                  return _context12.abrupt('return', Promise.resolve(N));
                case 30:
                case 'end':
            ...
            return _toConsumableArray(this.b.entries())
              .filter(function (_ref5) {
                var _ref6 = _slicedToArray(_ref5, 2),
                  n = _ref6[1];
                return n.source !== null && !_this0.f(n, t).isSingleton;
              })
          ...
          value: function computeLeakingDisposables() {
            ...
            if (r) n = r;
              ...
              var u = new Map(),
                a = _toConsumableArray(this.b.values()).filter(function (c) {
                  return c.source !== null && !_this1.f(c, u).isSingleton;
                });
            ...
            function i(u) {
              function a(c, m) {
                for (
                  ...
                  c.length > 0 &&
                  m.some(function (p) {
                    return typeof p == 'string' ? p === c[0] : c[0].match(p);
                  });
            ...
            try {
              for (_iterator22.s(); !(_step22 = _iterator22.n()).done; ) {
                var _u = _step22.value;
                var _a3 = i(_u);
                for (var _f2 = 0; _f2 <= _a3.length; _f2++) s.add(_a3.slice(0, _f2).join('\n'), _u);
              }
            } catch (err) {
              _iterator22.e(err);
            } finally {
            ...
            try {
              for (_iterator23.s(); !(_step23 = _iterator23.n()).done; ) {
                ...
                var _loop = function _loop(c) {
                  var m = _a4[c];
                  m = '(shared with '
                    .concat(s.get(_a4.slice(0, c + 1).join('\n')).size, '/')
                    .concat(n.length, ' leaks) at ')
                    .concat(m);
                  var L = s.get(_a4.slice(0, c).join('\n')),
                    R = hr(
                      _toConsumableArray(L).map(function (M) {
                        return i(M)[c];
                      }),
                      function (M) {
                        return M;
                  ...
                  delete R[_a4[c]];
                  for (
                    var _i2 = 0, _Object$entries = Object.entries(R);
...
function Q1(e) {
  var _f4;
  return (_f4 = f1) !== null && _f4 !== void 0 && _f4.trackDisposable(e), e;
}
function ee(e) {
  var _f5;
  (_f5 = f1) === null || _f5 === void 0 || _f5.markAsDisposed(e);
}
function te(e, t) {
  var _f6;
  (_f6 = f1) === null || _f6 === void 0 || _f6.setParent(e, t);
}
function Er(e, t) {
  if (f1) {
...
var re =
      ...
      return _createClass(vt, [
        {
          ...
          value: function dispose() {
            this.g || (ee(this), (this.g = !0), this.clear());
          },
        },
        {
          key: 'isDisposed',
        ...
        },
        {
          ...
          value: function deleteAndLeak(t) {
            t && this.f.has(t) && (this.f['delete'](t), te(t, null));
          },
        },
      ]);
    })()),
    (_vt.DISABLE_DISPOSED_WARNING = !1),
    _vt),
  v1 =
    ((_Class2 = /*#__PURE__*/ (function () {
      function v1() {
        _classCallCheck(this, v1);
        (this.B = new re()), Q1(this), te(this.B, this);
      }
      return _createClass(v1, [
        {
          key: 'dispose',
          value: function dispose() {
            ee(this), this.B.dispose();
          },
        },
        {
          key: 'D',
    ...
    return _createClass(xr, [
      ...
      },
      {
        ...
        value: function clear() {
          ...
          for (; e !== S.Undefined; ) {
            var _t1 = e.next;
            (e.prev = S.Undefined), (e.next = S.Undefined), (e = _t1);
          }
          (this.a = S.Undefined), (this.b = S.Undefined), (this.c = 0);
        },
      },
      ...
      },
      {
        ...
        value: function shift() {
          if (this.a !== S.Undefined) {
            var _e9 = this.a.element;
            return this.e(this.a), _e9;
          }
        },
      },
      {
        ...
        value: function pop() {
          if (this.b !== S.Undefined) {
            var _e0 = this.b.element;
            return this.e(this.b), _e0;
          }
        },
      },
      {
      ...
      {
        key: 'e',
        value: function e(_e8) {
          if (_e8.prev !== S.Undefined && _e8.next !== S.Undefined) {
            var _t10 = _e8.prev;
            (_t10.next = _e8.next), (_e8.next.prev = _t10);
          } else
            _e8.prev === S.Undefined && _e8.next === S.Undefined
              ? ((this.a = S.Undefined), (this.b = S.Undefined))
              : _e8.next === S.Undefined
                ? ((this.b = this.b.prev), (this.b.next = S.Undefined))
                : _e8.prev === S.Undefined && ((this.a = this.a.next), (this.a.prev = S.Undefined));
          this.c -= 1;
        },
      },
      {
  ...
  Pr = globalThis.performance && typeof globalThis.performance.now == 'function',
  Sr = /*#__PURE__*/ (function () {
    function bt(t) {
      _classCallCheck(this, bt);
      (this.c =
        Pr && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance)),
        (this.a = this.c()),
        (this.b = -1);
    }
    return _createClass(
...
(function (e) {
  ...
  function r(v, h) {
    return p(v, function () {}, 0, void 0, !0, void 0, h);
  }
  e.defer = r;
  function n(v) {
    return function (h) {
      ...
      return (
        (C = v(
          function ($) {
            if (!g) return C ? C.dispose() : (g = !0), h.call(b, $);
          },
          null,
          d,
        )),
  ...
  e.signal = u;
  function a() {
    for (var _len5 = arguments.length, v = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
  ...
  function p(v, h) {
    ...
    var $ = arguments.length > 6 ? arguments[6] : undefined;
    var j,
      U,
      a1,
      L1 = 0,
    ...
    var he = {
      ...
      onWillAddFirstListener: function onWillAddFirstListener() {
        j = v(function (Nt) {
          L1++,
            (U = h(U, Nt)),
            d && !a1 && (N1.fire(U), (U = void 0)),
            (d1 = function d1() {
              var At = U;
              (U = void 0), (a1 = void 0), (!d || L1 > 1) && N1.fire(At), (L1 = 0);
            }),
            typeof b == 'number'
              ? (clearTimeout(a1), (a1 = setTimeout(d1, b)))
              : a1 === void 0 && ((a1 = 0), queueMicrotask(d1));
        });
      },
      onWillRemoveListener: function onWillRemoveListener() {
        var _d;
        g && L1 > 0 && ((_d = d1) === null || _d === void 0 ? void 0 : _d());
      },
      onDidRemoveLastListener: function onDidRemoveLastListener() {
        (d1 = void 0), j.dispose();
      },
    ...
    $ || t(he);
    var N1 = new K(he);
    return $ !== null && $ !== void 0 && $.add(N1), N1.event;
  }
  e.debounce = p;
  function L(v) {
  ...
  function N(v, h) {
    ...
    var d = function d() {
        return $.fire(b.apply(void 0, arguments));
      },
      g = function g() {
        return v.on(h, d);
      },
      C = function C() {
        return v.removeListener(h, d);
      },
      $ = new K({
  ...
  function _(v, h) {
    ...
    var d = function d() {
      ...
      g = function g() {
        return v.addEventListener(h, d);
      },
      C = function C() {
        return v.removeEventListener(h, d);
      },
      $ = new K({
        onWillAddFirstListener: g,
        onDidRemoveLastListener: C,
  ...
  var yt = /*#__PURE__*/ (function () {
    function yt(h, b) {
      ...
      var d = {
        onWillAddFirstListener: function onWillAddFirstListener() {
          h.addObserver(_this11), _this11._observable.reportChanges();
        },
        onDidRemoveLastListener: function onDidRemoveLastListener() {
          h.removeObserver(_this11);
        },
      };
      b || t(d), (this.emitter = new K(d)), b && b.add(this.emitter);
    }
  ...
  function Ct(v, h) {
    return new yt(v, h).emitter.event;
  }
  e.fromObservable = Ct;
  function Lt(v) {
    return function (h, b, d) {
      ...
      v.addObserver($), v.reportChanges();
      var j = {
        dispose: function dispose() {
          v.removeObserver($);
        },
      };
      return d instanceof re ? d.add(j) : Array.isArray(d) && d.push(j), j;
    };
  }
  e.fromObservableLight = Lt;
})(M1 || (M1 = {}));
var Rr =
    ((_ce = /*#__PURE__*/ (function () {
      function ce(t) {
        ...
        (this.listenerCount = 0),
          ...
          (this.durations = []),
          (this.name = ''.concat(t, '_').concat(ce.f++)),
          ce.all.add(this);
      }
      return _createClass(ce, [
        {
          ...
          value: function start(t) {
            (this.g = new Sr()), (this.listenerCount = t);
          },
        },
        {
          key: 'stop',
          value: function stop() {
            if (this.g) {
              var _t11 = this.g.elapsed();
              this.durations.push(_t11),
                (this.elapsedOverall += _t11),
      ...
      return _createClass(gt, [
        ...
        },
        {
          ...
          value: function check(t, r) {
            ...
            return function () {
              var s = _this12.g.get(t.value) || 0;
              _this12.g.set(t.value, s - 1);
            };
          },
        },
        {
      ...
      [
        {
          ...
          value: function create() {
            var _t$stack;
            var t = new Error();
            return new pt((_t$stack = t.stack) !== null && _t$stack !== void 0 ? _t$stack : '');
          },
        },
      ],
    );
  })(),
  Mr = /*#__PURE__*/ (function (_Error4) {
    function Mr(e, t) {
      var _this13;
      _classCallCheck(this, Mr);
      (_this13 = _callSuper(this, Mr, [e])),
        (_this13.name = 'ListenerLeakError'),
        (_this13.stack = t);
      return _this13;
    }
    _inherits(Mr, _Error4);
    return _createClass(Mr);
  })(/*#__PURE__*/ _wrapNativeSuper(Error)),
  jr = /*#__PURE__*/ (function (_Error5) {
    function jr(e, t) {
      var _this14;
      _classCallCheck(this, jr);
      (_this14 = _callSuper(this, jr, [e])),
        (_this14.name = 'ListenerRefusalError'),
        (_this14.stack = t);
      return _this14;
    }
    _inherits(jr, _Error5);
    return _createClass(jr);
  })(/*#__PURE__*/ _wrapNativeSuper(Error)),
  Ir = 0,
  j1 = /*#__PURE__*/ _createClass(function j1(e) {
    _classCallCheck(this, j1);
    (this.value = e), (this.id = Ir++);
  }),
  Ur = 2,
  Dr = function Dr(e, t) {
    if (e instanceof j1) t(e);
    else
      for (var r = 0; r < e.length; r++) {
        var n = e[r];
        n && t(n);
...
if (kr) {
  ...
  setInterval(function () {
    _e1.length !== 0 &&
      ...
      console.warn(_e1.join('\n')),
      (_e1.length = 0));
  }, 3e3),
    (I1 = new FinalizationRegistry(function (t) {
      typeof t == 'string' && _e1.push(t);
    }));
}
          ...
          return (
            (_this$q = this.q) !== null && _this$q !== void 0
              ...
              : (this.q = function (e, t, r) {
                    ...
                    return (
                      (
                        ((_this15$f = _this15.f) === null || _this15$f === void 0
                          ? void 0
                          : _this15$f.onListenerError) || R1
                      )(a),
                      v1.None
                    );
                  }
                  if (_this15.m) return v1.None;
                  t && (e = e.bind(t));
                  var n = new j1(e);
                  var i, s;
                  _this15.g &&
                    _this15.z >= Math.ceil(_this15.g.threshold * 0.2) &&
                    ((n.stack = ne.create()), (i = _this15.g.check(n.stack, _this15.z + 1))),
                    je && (n.stack = s !== null && s !== void 0 ? s : ne.create()),
                    _this15.u
                      ? _this15.u instanceof j1
                  ...
                  var o = Me(function () {
                    var _I, _i4;
                    (_I = I1) !== null && _I !== void 0 && _I.unregister(o),
                      (_i4 = i) !== null && _i4 !== void 0 && _i4(),
                      _this15.A(n);
                  });
                  if ((r instanceof re ? r.add(o) : Array.isArray(r) && r.push(o), I1)) {
                    var _u3$;
      ...
      },
      {
        ...
        value: function fire(e) {
          ...
          if (
            ...
            if (this.u instanceof j1) this.B(this.u, e);
            else {
              var _t12 = this.w;
              _t12.enqueue(this, e, this.u.length), this.C(_t12);
            }
...
(function (e) {
  function t(r) {
    return r === e.None || r === e.Cancelled || r instanceof Wr
      ? !0
      : !r || _typeof(r) != 'object'
        ? !1
  ...
  (e.isCancellationToken = t),
    (e.None = Object.freeze({
      ...
      onCancellationRequested: M1.None,
    })),
    (e.Cancelled = Object.freeze({
      isCancellationRequested: !0,
      onCancellationRequested: Ue,
    }));
})(De || (De = {}));
var Wr = /*#__PURE__*/ (function () {
  ...
  return _createClass(Wr, [
    ...
    },
    {
      ...
      get: function get() {
        return this.a ? Ue : (this.b || (this.b = new K()), this.b.event);
      },
    },
    {
      key: 'dispose',
...
function Ve(e, t) {
  ...
  for (; r < n && i < s; r++, i++) {
    var u = e.charCodeAt(r),
      a = t.charCodeAt(i);
    if (u === a) continue;
    if (u >= 128 || a >= 128) return Br(e.toLowerCase(), t.toLowerCase(), r, n, i, s);
    He(u) && (u -= 32), He(a) && (a -= 32);
    var f = u - a;
    if (f !== 0) return f;
  }
...
function Zr(e, t) {
  return e.length === t.length && Ve(e, t) === 0;
}
function Kr(e, t) {
  var r = t.length;
  return t.length > e.length ? !1 : Ve(e, t, 0, r) === 0;
}
var J2 = '\uFEFF',
  Ze;
(function (e) {
...
var Y2 =
    ...
    (_w2.d = new Fr(
      ...
      function (t) {
        function r(f) {
          var c = new Map();
          for (var m = 0; m < f.length; m += 2) c.set(f[m], f[m + 1]);
          return c;
        }
        function n(f, c) {
          var m = new Map(f);
    ...
    (_w2.e = new qe(function () {
      return Object.keys(_w2.c.value).filter(function (t) {
    ...
    ((_y = /*#__PURE__*/ (function () {
      ...
      return _createClass(y1, null, [
        ...
        },
        {
          key: 'e',
          value: function e() {
            return this.d || (this.d = new Set(y1.c())), this.d;
          },
        },
        {
        ...
        },
        {
          ...
          value: function containsInvisibleCharacter(t) {
            for (var r = 0; r < t.length; r++) {
              var n = t.codePointAt(r);
              if (typeof n == 'number' && y1.isInvisibleCharacter(n)) return !0;
            }
            return !1;
          },
        },
...
function Xr(e) {
  return e.indexOf('/') === -1 && (e = ie(e)), /^[a-zA-Z]:(\/|$)/.test(e) && (e = '/' + e), e;
}
function Je(e) {
  ...
  var r = e.length,
    n = e.charCodeAt(0);
  if (r1(n)) {
    if (r1(e.charCodeAt(1)) && !r1(e.charCodeAt(2))) {
      var s = 3;
      var o = s;
      for (; s < r && !r1(e.charCodeAt(s)); s++);
      if (o !== s && !r1(e.charCodeAt(s + 1))) {
        for (s += 1; s < r; s++)
          if (r1(e.charCodeAt(s))) return e.slice(0, s + 1).replace(/[\\/]/g, t);
      }
    }
    return t;
  } else if (Yr(n) && e.charCodeAt(1) === 58)
    return r1(e.charCodeAt(2)) ? e.slice(0, 2) + t : e.slice(0, 2);
  var i = e.indexOf('://');
  if (i !== -1) {
    for (i += 3; i < r; i++) if (r1(e.charCodeAt(i))) return e.slice(0, i + 1);
  }
  return '';
}
function Xe(e, t, r) {
  var n = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : S1;
  if (e === t) return !0;
  ...
  Qr = /*#__PURE__*/ (function () {
    ...
    return _createClass(Qr, [
      ...
      },
      {
        key: 'g',
        get: function get() {
          return E.join(this.f, T.vscodeRemoteResource);
        },
      },
      {
        key: 'set',
      ...
      },
      {
        ...
        value: function rewrite(e) {
          ...
          return (
            typeof i == 'string' && (s += '&'.concat(Gr, '=').concat(encodeURIComponent(i))),
            z.from({
              scheme: It ? this.d : T.vscodeRemoteResource,
      ...
      return _createClass(z1, [
        ...
        },
        {
          ...
          value: function uriToBrowserUri(t) {
            return t.scheme === T.vscodeRemote
              ? e2.rewrite(t)
              : t.scheme === T.file &&
                  (jt || Dt === ''.concat(T.vscodeFileResource, '://').concat(z1.a))
                ? t['with']({
                    scheme: T.vscodeFileResource,
                    authority: t.authority || z1.a,
                    query: null,
                    fragment: null,
                  })
                : t;
        ...
        },
        {
          ...
          value: function uriToFileUri(t) {
            return t.scheme === T.vscodeFileResource
              ? t['with']({
                  scheme: T.file,
                  authority: t.authority !== z1.a ? t.authority : null,
                  query: null,
                  fragment: null,
                })
              : t;
...
(function (e) {
  ...
  function n(s) {
    ...
    typeof s == 'string'
      ...
      : s instanceof URL
        ? (o = s.searchParams)
        : z.isUri(s) && (o = new URL(s.toString(!0)).searchParams);
    var l = (_o2 = o) === null || _o2 === void 0 ? void 0 : _o2.get(r);
    if (l) return t.get(l);
  }
...
var se = /*#__PURE__*/ (function () {
    ...
    return _createClass(se, [
      {
        ...
        value: function compare(e, t) {
          ...
          return e === t ? 0 : Hr(this.getComparisonKey(e, r), this.getComparisonKey(t, r));
        },
      },
      {
        key: 'isEqual',
      ...
      },
      {
        ...
        value: function isEqualOrParent(e, t) {
          ...
          if (e.scheme === t.scheme) {
            if (e.scheme === T.file)
              return (
                Xe(Y(e), Y(t), this.a(e)) && e.query === t.query && (r || e.fragment === t.fragment)
              );
            if (Ge(e.authority, t.authority))
              return (
                Xe(e.path, t.path, this.a(e), '/') &&
                e.query === t.query &&
      ...
      },
      {
        ...
        value: function normalizePath(e) {
          ...
          var t;
          return (
            e.scheme === T.file ? (t = z.file(Qt(Y(e))).path) : (t = E.normalize(e.path)),
            e['with']({
              path: t,
            })
          );
      ...
      },
      {
        ...
        value: function relativePath(e, t) {
          if (e.scheme !== t.scheme || !Ge(e.authority, t.authority)) return;
          if (e.scheme === T.file) {
            var i = rr(Y(e), Y(t));
            return n1 ? ie(i) : i;
          }
      ...
      },
      {
        ...
        value: function hasTrailingPathSeparator(e) {
          var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : S1;
          if (e.scheme === T.file) {
            var r = Y(e);
            return r.length > Je(r).length && r[r.length - 1] === t;
          } else {
            var _r3 = e.path;
            return (
              _r3.length > 1 &&
      ...
      },
      {
        ...
        value: function addTrailingPathSeparator(e) {
          ...
          if (e.scheme === T.file) {
            var n = Y(e);
            r = n !== void 0 && n.length === Je(n).length && n[n.length - 1] === t;
          } else {
            t = '/';
            var _n5 = e.path;
            r = _n5.length === 1 && _n5.charCodeAt(_n5.length - 1) === 47;
          }
          return !r && !Qe(e, t)
            ? e['with']({
                path: e.path + '/',
  ...
  Q2 = new se(function (e) {
    return e.scheme === T.file ? !Mt : !0;
  }),
  en = new se(function (e) {
    return !0;
  }),
  tn = A.isEqual.bind(A),
  rn = A.isEqualOrParent.bind(A),
  nn = A.getComparisonKey.bind(A),
  sn = A.basenameOrAuthority.bind(A),
  s2 = A.basename.bind(A),
  on = A.extname.bind(A),
  ln = A.dirname.bind(A),
  o2 = A.joinPath.bind(A),
  an = A.normalizePath.bind(A),
  un = A.relativePath.bind(A),
  cn = A.resolvePath.bind(A),
  fn = A.isAbsolutePath.bind(A),
  Ge = A.isEqualAuthority.bind(A),
  Qe = A.hasTrailingPathSeparator.bind(A),
  hn = A.removeTrailingPathSeparator.bind(A),
  dn = A.addTrailingPathSeparator.bind(A),
  et;
(function (e) {
      ...
      [
        {
          ...
          value: function _with() {
            ...
            return t === this.lineNumber && r === this.column ? this : new s1(t, r);
          },
        },
        {
          key: 'delta',
        ...
        },
        {
          ...
          value: function equals(t) {
            return s1.equals(this, t);
          },
        },
        {
          key: 'isBefore',
          value: function isBefore(t) {
            return s1.isBefore(this, t);
          },
        },
        {
          key: 'isBeforeOrEqual',
          value: function isBeforeOrEqual(t) {
            return s1.isBeforeOrEqual(this, t);
          },
        },
        {
          key: 'clone',
          value: function clone() {
            return new s1(this.lineNumber, this.column);
          },
        },
        {
          key: 'toString',
      ...
      [
        ...
        },
        {
          ...
          value: function lift(t) {
            return new s1(t.lineNumber, t.column);
          },
        },
        {
          key: 'isIPosition',
      ...
      [
        ...
        },
        {
          ...
          value: function getEndPosition(t) {
            return new b1(t.endLineNumber, t.endColumn);
          },
        },
        {
          key: 'getStartPosition',
          value: function getStartPosition(t) {
            return new b1(t.startLineNumber, t.startColumn);
          },
        },
        {
          key: 'collapseToStart',
...
var vn =
                      ...
                      return _regeneratorRuntime().wrap(function _callee6$(_context17) {
                        while (1)
                          switch ((_context17.prev = _context17.next)) {
                            ...
                            case 6:
                              _context17.next = 8;
                              return M1.toPromise(_this17.g.event);
                            case 8:
                              if (!0) {
                                _context17.next = 0;
                                break;
    ...
    (_H.EMPTY = _H.fromArray([])),
    _H),
  a2 = '`~!@#$%^&*()-=+[{]}\\|;:\'",.<>/?';
function u2() {
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var t = '(-?\\d*\\.\\d\\w*)|([^';
  var _iterator31 = _createForOfIteratorHelper(a2),
    _step31;
  try {
...
function lt(e, t, r, n, i) {
  if (((t = st(t)), i || (i = T1.first(ot)), r.length > i.maxLen)) {
    var a = e - i.maxLen / 2;
    return a < 0 ? (a = 0) : (n += a), (r = r.substring(a, e + i.maxLen / 2)), lt(e, t, r, n, i);
  }
  var s = Date.now(),
    o = e - 1 - n;
  var l = -1,
...
var h2 = /*#__PURE__*/ (function () {
        ...
        value: function onEvents(e) {
          ...
          try {
            for (_iterator32.s(); !(_step32 = _iterator32.n()).done; ) {
              var r = _step32.value;
              this.k(r.range), this.l(new b1(r.range.startLineNumber, r.range.startColumn), r.text);
            }
          } catch (err) {
            _iterator32.e(err);
          } finally {
        ...
        value: function h() {
          if (!this.f) {
            var _e11 = this.c.length,
              _t14 = this.b.length,
              r = new Uint32Array(_t14);
            for (var n = 0; n < _t14; n++) r[n] = this.b[n].length + _e11;
            this.f = new h2(r);
          }
        },
      },
    ...
    return _createClass(b2, [
      ...
      },
      {
        ...
        value: function $acceptNewModel(e) {
          this.a[e.url] = new g2(z.parse(e.url), e.lines, e.EOL, e.versionId);
        },
      },
      {
  ...
  g2 = /*#__PURE__*/ (function (_m) {
    function g2() {
      _classCallCheck(this, g2);
      return _callSuper(this, g2, arguments);
    }
    _inherits(g2, _m);
    return _createClass(g2, [
      ...
      },
      {
        ...
        value: function getWordAtPosition(e, t) {
          var r = lt(e.column, st(t), this.b[e.lineNumber - 1], 0);
          return r ? new tt(e.lineNumber, r.startColumn, e.lineNumber, r.endColumn) : null;
        },
      },
      {
      ...
      },
      {
        key: 'o',
        value: function o(e) {
          if (!b1.isIPosition(e)) throw new Error('bad position');
          var t = e.lineNumber,
            r = e.column,
            n = !1;
          if (t < 1) (t = 1), (r = 1), (n = !0);
  ...
  p2 = /*#__PURE__*/ (function () {
    function fe(t) {
      ...
      (this.a = new b2()), (this.b = new Map()), this.a.bindToServer(t);
    }
    return _createClass(
      fe,
      [
        {
          key: '$setWorkspaceFolders',
          value: function $setWorkspaceFolders(t) {
            this.c(t);
          },
        },
        {
        ...
        },
        {
          key: 'd',
          value: function d(t) {
            return this.a.getModel(t);
          },
        },
        {
          key: '$computeLinks',
          value: function $computeLinks(t) {
            var r = this.d(t);
            if (!r) return [];
            var n = [],
              i = Fe(r.getValue());
            var _iterator36 = _createForOfIteratorHelper(this.b),
              _step36;
            try {
              var _loop2 = function _loop2() {
                var _step36$value = _slicedToArray(_step36.value, 2),
                  ...
                  o = _step36$value[1];
                var l = {
                  toResource: function toResource(u) {
                    return typeof u == 'string' ? o2(s, u) : null;
                  },
                };
                for (var u = 0, a = i.length; u < a; u++)
                  n.push.apply(n, _toConsumableArray(fe.detectLinks(i[u], u + 1, o, l)));
              };
      ...
      [
        {
          key: 'createPatterns',
          value: function createPatterns(t) {
            var r = [],
              n = t.scheme === T.file ? t.fsPath : t.path,
              i = [n];
            n1 && t.scheme === T.file && i.push(ie(n));
            for (var _i8 = 0, _i7 = i; _i8 < _i7.length; _i8++) {
              var s = _i7[_i8];
              var o = '[^\\s\\(\\):<>\'"]',
                u = ''.concat('(?:'.concat(o, '| ').concat(o, ')'), '+\\.', o, '+'),
                a = ''.concat(o, '+');
              r.push(
                new RegExp(U1(s) + '('.concat(u, ') on line ((\\d+)(, column (\\d+))?)'), 'gi'),
              ),
                r.push(
                  new RegExp(U1(s) + '('.concat(u, '):line ((\\d+)(, column (\\d+))?)'), 'gi'),
                ),
                r.push(new RegExp(U1(s) + '('.concat(u, ')(\\s?\\((\\d+)(,(\\d+))?)\\)'), 'gi')),
                r.push(new RegExp(U1(s) + '('.concat(a, ')(:(\\d+))?(:(\\d+))?'), 'gi'));
            }
            return r;
          },
        },
        {
          key: 'detectLinks',
          value: function detectLinks(t, r, n, i) {
            var s = [];
            return (
              n.forEach(function (o) {
                ...
                var _loop3 = function _loop3() {
                    var a = ze(l[1], '.').replace(/\\/g, '/');
                    var f;
                    try {
                      var L = i.toResource(a);
                      L && (f = L.toString());
                    } catch (_unused5) {
                      return 0; // continue
                    }
                    ...
                    var p = {
                      startColumn: m + 1,
                      startLineNumber: r,
                      endColumn: m + 1 + c.length,
                      endLineNumber: r,
                    };
                    if (
                      s.some(function (L) {
                        return tt.areIntersectingOrTouching(L.range, p);
                      })
                    )
                      return {
                        v: void 0,
...
var C2 = /*#__PURE__*/ _createClass(function C2(e, t, r, n, i) {
  ...
  ct = /*#__PURE__*/ _createClass(function ct(e, t, r, n) {
    _classCallCheck(this, ct);
    (this.vsWorker = e), (this.seq = t), (this.res = r), (this.err = n), (this.type = 1);
  }),
  L2 = /*#__PURE__*/ _createClass(function L2(e, t, r, n, i) {
  ...
  N2 = /*#__PURE__*/ _createClass(function N2(e, t, r) {
    _classCallCheck(this, N2);
    (this.vsWorker = e), (this.req = t), (this.event = r), (this.type = 3);
  }),
  A2 = /*#__PURE__*/ _createClass(function A2(e, t) {
        ...
        value: function sendMessage(e, t, r) {
          ...
          return new Promise(function (i, s) {
            (_this19.c[n] = {
              ...
              _this19.o(new C2(_this19.a, n, e, t, r));
          });
        },
      },
      {
        ...
        value: function listen(e, t, r) {
          ...
          var i = new K({
            onWillAddFirstListener: function onWillAddFirstListener() {
              (n = String(++_this20.b)),
                _this20.d.set(n, i),
                _this20.o(new L2(_this20.a, n, e, t, r));
            },
            onDidRemoveLastListener: function onDidRemoveLastListener() {
              _this20.d['delete'](n), _this20.o(new A2(_this20.a, n)), (n = null);
            },
          });
          return i.event;
        },
            ...
            get: function get(n, i) {
              return (
                typeof i == 'string' &&
                  ...
                  (ht(i)
                    ? (n[i] = function (s) {
                        return _this21.listen(e, i, s);
                      })
                    : ft(i)
                      ? (n[i] = _this21.listen(e, i, void 0))
                      : i.charCodeAt(0) === 36 &&
                        (n[i] = /*#__PURE__*/ _asyncToGenerator(
                          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee15() {
                            var _len8,
                              ...
                              _key8,
                              _args28 = arguments;
                            return _regeneratorRuntime().wrap(function _callee15$(_context28) {
                              while (1)
                                switch ((_context28.prev = _context28.next)) {
                                  case 0:
                                    for (
                                      _len8 = _args28.length, s = new Array(_len8), _key8 = 0;
                                      _key8 < _len8;
                                      _key8++
                                    ) {
                                      s[_key8] = _args28[_key8];
                                    }
                                    _context28.next = 3;
      ...
      },
      {
        ...
        value: function k(e) {
          ...
          this.g.handleMessage(e.channel, e.method, e.args).then(
            function (n) {
              _this22.o(new ct(_this22.a, t, n, void 0));
            },
            function (n) {
              n.detail instanceof Error && (n.detail = xe(n.detail)),
                _this22.o(new ct(_this22.a, t, void 0, xe(n)));
            },
          );
        },
      },
        ...
        value: function l(e) {
          ...
          var t = e.req,
            r = this.g.handleEvent(
              ...
              _this23.o(new N2(_this23.a, t, n));
            });
          this.f.set(t, r);
        },
      },
...
function ft(e) {
  return e[0] === 'o' && e[1] === 'n' && Be(e.charCodeAt(2));
}
function ht(e) {
  return /^onDynamic/.test(e) && Be(e.charCodeAt(9));
}
      ...
      (this.d = new Map()),
        ...
        (this.c = new $2({
          ...
          handleMessage: function handleMessage(r, n, i) {
            return _this24.g(r, n, i);
          },
          handleEvent: function handleEvent(r, n, i) {
            return _this24.h(r, n, i);
          },
        }));
    }
    return _createClass(E2, [
      ...
      },
      {
        ...
        value: function g(e, t, r) {
          if (e === le && t === y2) return this.j(r[0], r[1], r[2]);
          var n = e === le ? this.b : this.d.get(e);
          if (!n)
      ...
      },
      {
        ...
        value: function getChannel(e) {
          if (!this.f.has(e)) {
            var _t15 = this.c.createProxyToRemoteChannel(e);
            this.f.set(e, _t15);
          }
          return this.f.get(e);
        },
      },
      {
        ...
        value: (function () {
          var _j = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee16(e, t, r) {
              var _this25 = this;
              return _regeneratorRuntime().wrap(
                    ...
                    switch ((_context29.prev = _context29.next)) {
                      ...
                      case 3:
                        return _context29.abrupt(
                          ...
                          })(''.concat(i2.asBrowserUri(''.concat(r, '.js')).toString(!0))).then(
                            function (i) {
                              if (((_this25.b = i.create(_this25)), !_this25.b))
...
//# debugId=deecdd7a-55c6-509b-a1b5-dfe25a01c4e0
